<?php
    ...
    <a href='tailor_dash.php'><button id='alert_btn'>OK</button></a></div>";
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <div class="stu_info">
                    ...
                    <div class="row">
                        <div class="col-75">
                            <input type="text" id="rollno" name="rollno" placeholder="Rollno.." value="<?php echo $rollno ?>">
                    ...
                    <div class="row">
                        <div class="col-75">
                            <input type="text" id="fname" name="firstname" placeholder="First Name.." value="<?php echo $fname ?>">
                            <span class="error"><?php echo $fnameErr ?></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-75">
                            <input type="text" id="lname" name="lastname" placeholder="Last Name.." value="<?php echo $lname ?>">
                            <span class="error"><?php echo $lnameErr ?></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-75">
                            <input type="number" id="num" name="num" placeholder="Phone no.." value="<?php echo $pno ?>">
