<?php
    ...
    $pnolength=strlen($pno);
        if (isset($_POST['submit'])){
            if (empty($fname)){
            ...
            }else if($depart=="department"){
                $departErr="*Please select your department";
            }
            else if(empty($pno)){
                ...
                $sql="select * from admin_reg where pno=$pno or email='$email'";
                ...
                { 
                    $sql1="insert into admin_reg (fname,lname,gender,depart,pno,email,pass,cpass) 
                    values('".$fname."','".$lname."','".$gender."',
                    '".$depart."','".$pno."','".$email."','".$pass."','".$cpass."')";
...
<body>
    ...
    <div class="container">
        <form action="#" method="post">
            <fieldset>
                <legend style="font-size: 30px; color:white; width:auto; letter-spacing:2px">Admin SignUp Form</legend>
                <div class="row">
                    <div class="col-75">
                ...
                <div class="row">
                    <div class="col-75">
                        <select id="department" name="department">
                            ...
                            <option value="Computer Application" <?php if($depart=="Computer Application")echo "selected" ?>>Computer Application</option>
                            <option value="Bussiness Administration" <?php if($depart=="Bussiness Administration")echo "selected" ?>>Bussiness Administration</option>
                        </select>
