...
if (isset($_POST['update'])) {
    $sql = "update tailor_reg set fname='{$_POST['firstname']}',lname='{$_POST['lastname']}',gender='{$_POST['gender']}',
        pno={$_POST['pno']},email='{$_POST['email']}',pass='{$_POST['pass']}' where tailor_id={$_POST['tailor_id']}";
...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="active" href="tailor_profile.php"><i class="fa fa-user"></i><span>Profile</span></a>
    </div>
    <?php
    $sql = "select fname,lname,gender,pno,email,pass from tailor_reg where tailor_id='" . $_SESSION['tailor_id'] . "'";
    ...
    if ($res->num_rows > 0) {
        ...
        while ($row = $res->fetch_assoc()) {
            echo "<p>Firstname : " . $row['fname'] . "</p>" . "<p>Lastname : " . $row['lname'] . "</p>" .
                "<p>Gender : " . $row['gender'] . "</p>" . "<p>Phone number : " . $row['pno'] . "</p>" . "<p>Email : " . $row['email'] . "</p>" . "<p>Password : " . '######' . "</p>" .
    ...
    ?>
    <?php
    $sql = "select tailor_id,fname,lname,gender,pno,email,pass from tailor_reg where tailor_id='" . $_SESSION['tailor_id'] . "'";
    $res = $connect->query($sql);
    if ($res->num_rows > 0) {
            ...
            echo '<div class="row">
                ...
                <div class="row">
                    <div class="col-75">
                        ...
                        <input type="submit" name="update" value="Update" style="margin-left:40%">
                    </div>
                </div>';
        }
        echo "</div>";
